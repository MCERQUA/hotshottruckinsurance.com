...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "FMCSA mortality insurance",
    "owner-operator mortality insurance",
    "hot shot trucking property insurance",
    "cargoing parlor insurance",
    "cargo spoilage insurance",
    "equipment breakdown dairy",
    "dairy product liability",
    "manure runoff pollution insurance",
    "dairy workers compensation",
    "cargo tanker commercial auto",
  ],
  ...
  openGraph: {
    ...
    description:
      "Specialized insurance for hot shot truckings — owner-operator mortality, cargoing parlor & barn property, equipment breakdown with cargo spoilage, product liability, manure-runoff pollution, workers' comp, and commercial auto. Licensed all 50 states. 15-min quotes.",
  ...
  twitter: {
    ...
    title: `${SITE.name} | Contractors Choice Agency`,
    description:
      "Specialized insurance for hot shot truckings. Livestock mortality, parlor & barn property, equipment breakdown & cargo spoilage, product liability, pollution, workers' comp, and auto. 15-minute quotes.",
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const orgSchema = {
    ...
    serviceType: [
      ...
      "Equipment Breakdown & Cargo Spoilage Insurance",
      "Dairy Product Liability Insurance",
      "General Liability Insurance for Hot Shot Trucks",
      "Workers' Compensation for Dairy Crews",
      "Commercial Auto & Trucking for Cargo Tankers",
