...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "1-ton pickup commercial insurance",
  ...
  twitter: {
    ...
    title: `${SITE.name} | Contractors Choice Agency`,
    description:
      "Specialized insurance for hot shot truckers and owner-operators. Motor carrier authority, cargo, physical damage, bobtail, trailer interchange, non-trucking liability, general liability, and occupational accident coverage. 15-minute quotes.",
